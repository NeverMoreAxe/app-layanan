...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('information_pages', function (Blueprint $table) {
            ...
            $table->string('category')->index(); // InformationCategory: program|rehabilitation|disability|elderly|complaint|other
            ...
            $table->string('publish_status')->default('draft')->index(); // PublishStatus: draft|published|archived
