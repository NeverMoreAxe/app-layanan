...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('rehabilitation_cases', function (Blueprint $table) {
            ...
            $table->string('handling_type')->default('direct'); // HandlingType: direct|referral|both
            $table->string('status')->index(); // RehabilitationCaseStatus enum
        ...
        Schema::create('referrals', function (Blueprint $table) {
            ...
            $table->string('status')->index(); // ReferralStatus enum
        ...
        Schema::create('monitoring_records', function (Blueprint $table) {
            ...
            $table->foreignId('officer_id')->constrained('users')->restrictOnDelete();
            $table->date('monitoring_date')->index();
            $table->text('progress');
