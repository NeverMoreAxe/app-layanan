...
class User extends Authenticatable implements FilamentUser
{
    ...
    public function assessmentsHandled(): HasMany
    {
        return $this->hasMany(Assessment::class, 'officer_id');
    }

    public function referralsHandled(): HasMany
    {
        return $this->hasMany(Referral::class, 'officer_id');
    }

    public function monitoringRecordsHandled(): HasMany
    {
        return $this->hasMany(MonitoringRecord::class, 'officer_id');
    }

    public function informationPagesManaged(): HasMany
    {
